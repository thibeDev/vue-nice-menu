...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('div', {
    ...
    return _vm._ssrNode("<div class=\"sub-menu\"" + _vm._ssrStyle(null, _vm.getSubMenu(key), null) + ">", "</div>", [item.isRouterLink ? _c('router-link', _vm._b({
...
var __vue_module_identifier__ = "data-v-57d89fdf";
/* functional template */
